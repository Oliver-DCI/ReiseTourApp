...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-r from-[#e6dfd3] via-[#d4c7b4] to-[#b8a894] text-[#3a3a3a] py-12 border-t border-[#a89b88] mt-10">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          {/* Über uns */}
          <div>
            <h3 className="text-[#c9a227] text-xl font-bold mb-4 italic">
              GoldenWings
            </h3>
        ...
        <div className="border-t border-[#a89b88] mt-12 pt-8 text-center text-sm text-[#4a4a4a]">
          <p className="text-2xl text-[#c9a227] font-bold italic">GoldenWings</p>
          <p>© {new Date().getFullYear()} GoldenWings – Alle Rechte vorbehalten.</p>
